...
# may throw an error!  
# Please note that moon_position and 
...
def acceleration(moon_position, spaceship_position):
    ...
    vector_earth = -1*spaceship_position
    return gravitational_constant * (earth_mass/numpy.linalg.norm(vector_earth)**3 * vector_earth + moon_mass/numpy.linalg.norm(vector_moon)**3 * vector_moon)
